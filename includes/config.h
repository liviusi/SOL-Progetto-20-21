 ...
 * @param config_file_path cannot be NULL.
 ...
 * specified for the routines "fopen", "fgets", "strtoul".
*/
int
 ...
 * @returns Length of the string identifying log file
 ...
 * @returns Length of the string identifying socket file path
