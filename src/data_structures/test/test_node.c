...
int main()
{
	...
	node_t* node1 = Node_Create(key, strlen(key) + 1, (void*) data, strlen(data) + 1);
	strncpy(key, node2_tmp_key, 128);
	strncpy(data, node2_tmp_data, 128);
	node_t* node2 = Node_Create(key, strlen(key) + 1, (void*) data, strlen(data) + 1);
	strncpy(key, node3_tmp_key, 128);
	strncpy(data, node3_tmp_data, 128);
	node_t* node3 = Node_Create(key, strlen(key) + 1, (void*) data, strlen(data) + 1);
	strncpy(key, node4_tmp_key, 128);
	strncpy(data, node4_tmp_data, 128);
	node_t* node4 = Node_Create(key, strlen(key) + 1, (void*) data, strlen(data) + 1);
	strncpy(key, node5_tmp_key, 128);
	strncpy(data, node5_tmp_data, 128);
	node_t* node5 = Node_Create(key, strlen(key) + 1, (void*) data, strlen(data) + 1);
	strncpy(key, node6_tmp_key, 128);
	strncpy(data, node6_tmp_data, 128);
	node_t* node6 = Node_Create(key, strlen(key) + 1, (void*) data, strlen(data) + 1);
	strncpy(key, node7_tmp_key, 128);
	strncpy(data, node7_tmp_data, 128);
	node_t* node7 = Node_Create(key, strlen(key) + 1, (void*) data, strlen(data) + 1);
	strncpy(key, node8_tmp_key, 128);
	strncpy(data, node8_tmp_data, 128);
	node_t* node8 = Node_Create(key, strlen(key) + 1, (void*) data, strlen(data) + 1);
	strncpy(key, node9_tmp_key, 128);
	strncpy(data, node9_tmp_data, 128);
	node_t* node9 = Node_Create(key, strlen(key) + 1, (void*) data, strlen(data) + 1);
	strncpy(key, node10_tmp_key, 128);
	strncpy(data, node10_tmp_data, 128);
	node_t* node10 = Node_Create(key, strlen(key) + 1, (void*) data, strlen(data) + 1);
	free(key);
	free(data);
